...
class SummaryDepressionAnalysis:
    ...
    def summary(self):
        ...
        self.chart.heatmap(self.correlation.getCorrelationMatrix(self.root_file), model_name='correlation', title='Correlation Matrix', x_label='Features', y_label='Features', statistic_name='correlation_matrix')
        for key, value in self.file.iterrows():
            ...
            self.chart.heatmap(self.jsonutils.stringToJson(value['confusion_matrix']), model_name=value['model_name'], title=f'{value['model_name']} Classification Report', x_label='Predicted', y_label='Actual', statistic_name='confusion_matrix')